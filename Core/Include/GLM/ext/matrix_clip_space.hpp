...
namespace Core
{
	...
	///
	/// @see - Core::ortho(T const& left, T const& right, T const& bottom, T const& top, T const& zNear, T const& zFar)
	...
	/// @tparam T A floating-point scalar type
	///
	/// @see - Core::ortho(T const& left, T const& right, T const& bottom, T const& top)
	template<typename T>
