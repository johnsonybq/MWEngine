...
namespace detail
{
	...
	struct compute_sign
	{
		...
		{
			return vec<L, T, Q>(Core::lessThan(vec<L, T, Q>(0), x)) - vec<L, T, Q>(Core::lessThan(x, vec<L, T, Q>(0)));
		}
	};
...
#	endif
	...
	struct compute_step_vector
	{
		...
		{
			return mix(vec<L, T, Q>(1), vec<L, T, Q>(0), Core::lessThan(x, edge));
		}
	};
