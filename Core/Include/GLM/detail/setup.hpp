...
#	define GLM_COUNTOF(arr) Core::countof(arr)
...
#	endif
	...
	// Report .length() type
#	if GLM_CONFIG_LENGTH_TYPE == GLM_LENGTH_SIZE_T
#		pragma message("GLM: GLM_FORCE_SIZE_T_LENGTH is defined. .length() returns a Core::length_t, a typedef of std::size_t.")
#	else
#		pragma message("GLM: GLM_FORCE_SIZE_T_LENGTH is undefined. .length() returns a Core::length_t, a typedef of int following GLSL.")
#	endif
